...
wall_to_break = mahjong_walls_ordered[sorted_roll_dict[-1]].value()

wall_break_position = wall_to_break[dealer_roll[3]]

print ('the wall break side is:', wall_break_side, 'the wall break position is:',wall_break_position)
...
#another way to draw tiles propoerly according to the dice reads# 

mahjong_pile_to_start_with = mahjong_walls.get(wall_break_side)[wall_break_position:wall_break_position +3]
mahjong_walls_reorganized = mahjong_walls.index
